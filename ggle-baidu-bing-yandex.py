...
def bing_translate(frm_bing, to_bing):
    ...
    bing_param = {'text': 'i have done this',
              'from': 'en',
              'to': 'bn'
    }
    bing_param_detect = {'text': 'i have done this'}
...
def googel_translate():
     while True:
          ...
          url_yandex = 'https://translate.yandex.net/api/v1/tr.json/translate?id=6d3ae0b0.5cbf4919.6cddeec8-4-0&srv=tr-text&lang=en-bn&reason=auto' # only for bangla need to modify.
